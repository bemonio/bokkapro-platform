...
TRANSLATIONS = {
    "en": {
        ...
        "offices": {
            ...
            "map_select_hint": "Click on the map to place the pin and get the nearest address.",
    ...
    "es": {
        ...
        "offices": {
            ...
            "map_select_hint": "Haz clic en el mapa para colocar el pin y obtener la dirección más cercana.",
